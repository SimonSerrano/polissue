...
public class Constant {
    ...
    //FXML files
    public static final String MAIN_PAGE_FXML = "/fxml/main_view_updated.fxml";
    ...
    public static final String FIVE_CATEGORY = System.getProperty("user.dir")+"src/main/resources/img/polissue-five-category.png";
